...
MINGW_NJOB			:= 5
SSE_LEVEL			:= 0
LINUX_FLAG			:= -DCMAKE_SYSTEM_NAME=Linux -DSOUND_API=openal -DBUILD_TYPE=Linux
MINGW_FLAG			:= -DCMAKE_SYSTEM_NAME=Generic -DSOUND_API=openal -DBUILD_TYPE=MinGW
ANDROID_X86_FLAG	:= -DCMAKE_SYSTEM_NAME=Linux -DSOUND_API=opensl -DBUILD_TYPE=AndroidX86 -DUSE_CLANG=YES
...
CMake = mkdir -p $(1); cd $(1); cmake $(PWD) -G 'Unix Makefiles' -DCMAKE_BUILD_TYPE=$(3) -DCMAKE_INSTALL_PREFIX=$(INSTALL_PATH) $(2) ;
Make = cd $(1); make -j$(2);
Test = cd $(1); make test;
